<?php
	...
	{   
	    ...
	    $keys=array('type','table_name','search_col_name','search_col_mail','get_colms','get_id');
	    $value=array(array('string','mock_test_tbl','name','email','null as name,id,null as email,null as phone,null as gender','id'));
	    $query_data=array();
